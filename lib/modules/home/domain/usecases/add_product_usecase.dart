...
class AddProductUsecase
    extends BaseUsecase<AddProductModel, AddProductUsecaseParams> {
  ...
  Future<Either<HttpError, AddProductModel>> call(params) async {
    return await homeRepository.addProduct(params);
  }
}
...
class AddProductUsecaseParams {
  ...
  AddProductUsecaseParams.fromJson(Map<String, dynamic> json) {
